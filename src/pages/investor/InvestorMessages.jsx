...
const InvestorMessages = () => {
    ...
    try {
      ...
      const conversationsWithDetails = await Promise.all(
        response.data.map(async (conv) => {
          const otherUserId = conv.creatorId;
          try {
            ...
            return {
              ...conv,
              otherUser: { profile: { fullName: 'Unknown User', photo: null } },
  ...
  const startNewConversation = async (projectId) => {
    try {
      ...
      if (existingConv) {
        ...
        navigate(`/investor/messages?conversation=${existingConv.id}`, { replace: true });
      } else {
        ...
        setConversations([fullConversation, ...conversations]);
        setActiveConversation(fullConversation);
        navigate(`/investor/messages?conversation=${fullConversation.id}`, { replace: true });
      }
    } catch (error) {
  ...
  const filteredConversations = conversations
    .filter(c => {
      ...
      if (filter === 'documents') return c.sharedDocuments?.length > 0;
      return true;
    })
    .filter(c => {
              ...
              <div className="flex flex-col items-center justify-center h-full px-6 text-center">
                ...
                <p className="text-sm text-neutral-500 mb-6">
                  {filter !== 'all' 
                    ...
                    : 'Start by discovering projects and reaching out to creators'
                  }
                </p>
                {filter === 'all' && (
                  <Button 
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        ...
                        markAsRead(conv.id);
                        navigate(`/investor/messages?conversation=${conv.id}`, { replace: true });
                      }}
                      className={clsx(
                      ...
                      <div className="flex items-start gap-3">
                        <div className="relative flex-shrink-0">
                          {conv.otherUser?.profile?.photo ? (
                            ...
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-primary-dark text-white flex items-center justify-center font-display font-bold text-lg shadow-sm">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-0.5">
                            <h4 className={clsx(
                              ...
                              {conv.otherUser?.profile?.fullName || 'Unknown User'}
                            </h4>
                          ...
                          <div className="flex gap-2 mt-1.5">
                            ...
                            {conv.sharedDocuments?.length > 0 && (
                              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-blue-50 text-blue-700 rounded text-[10px] font-semibold">
                                <FileText size={10} />
                                {conv.sharedDocuments.length}
                              </span>
                            )}
                          </div>
                        </div>
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-display font-bold text-lg text-neutral-900">
                      {activeConversation.otherUser?.profile?.fullName || 'Creator'}
                    </h3>
                    {activeConversation.otherUser?.profile?.company && (
            ...
            {showSearch && (
              <div className="px-6 py-3 bg-neutral-50 border-b border-neutral-200">
                ...
                <div className="mt-2 text-xs text-neutral-500">
                  {activeConversation.messages?.length || 0} messages in this conversation
                </div>
              </div>
            )}
              ...
              {(!activeConversation.messages || activeConversation.messages.length === 0) ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-neutral-600 max-w-md mb-8 text-lg">
                    Introduce yourself and discuss investment opportunities with {activeConversation.otherUser?.profile?.fullName?.split(' ')[0] || 'the creator'}.
                  </p>
                  
                  <div className="grid grid-cols-2 gap-4 max-w-md">
                    <button
                      onClick={() => setMessage("Hi! I'm interested in your project and would love to learn more about your traction and growth plans.")}
                    ...
                    >
                      ...
                      <p className="text-xs text-neutral-600">Express interest in the project</p>
                    </button>
                    
                    <button
                      onClick={() => setMessage("I've reviewed your pitch and would like to schedule a call to discuss potential investment. When are you available?")}
                      className="p-4 bg-white border-2 border-neutral-200 rounded-lg hover:border-primary hover:bg-primary/5 transition-all text-left"
                    >
                      <div className="font-display font-semibold text-sm mb-1 flex items-center gap-2">
                      ...
                      <p className="text-xs text-neutral-600">Propose a meeting to discuss details</p>
                    </button>
                    
                    <button
                      onClick={() => setMessage("Could you share more details about your unit economics and customer acquisition costs?")}
                      className="p-4 bg-white border-2 border-neutral-200 rounded-lg hover:border-primary hover:bg-primary/5 transition-all text-left"
                    >
                      <div className="font-display font-semibold text-sm mb-1 flex items-center gap-2">
                      ...
                      <p className="text-xs text-neutral-600">Request financial details</p>
                    </button>
                    
                    <button
                      onClick={() => setMessage("I've signed the NDA. Can you grant me access to the full pitch deck and financial model?")}
                      className="p-4 bg-white border-2 border-neutral-200 rounded-lg hover:border-primary hover:bg-primary/5 transition-all text-left"
                    >
                      <div className="font-display font-semibold text-sm mb-1 flex items-center gap-2">
                      ...
                      <p className="text-xs text-neutral-600">Unlock NDA-protected content</p>
                    </button>
                  </div>
                </div>
              ) : (
              ...
              <div className="flex items-end gap-2">
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    (!message.trim() && attachments.length === 0) || sendingMessage
          ...
          <div className="flex-1 flex items-center justify-center bg-neutral-50">
            <div className="text-center max-w-md px-6">
              ...
              <p className="text-neutral-600 text-lg mb-8">
                Select a conversation to start messaging with creators and discussing investment opportunities.
              </p>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-blue-700">
                    A video meeting link will be automatically generated and shared with both parties.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-50 p-4 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-amber-700">
                    Documents shared in this chat are encrypted and only visible to you and the creator.
                  </p>
                </div>
              </div>
